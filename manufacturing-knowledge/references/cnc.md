...
- **Stock Volume**: $X\_{mm} \\times Y\_{mm} \\times Z\_{mm} / 1000$ to get $cm^3$.
- **Formula**: $StockMass\_{kg} \\times MaterialPrice\_{/kg}$.
...
- **Machining Time**: Driven by the Material Removal Rate (MRR).
  - $Time\_{min} = RemovedVolume\_{mm^3} / MRR$.
  - Default MRR: $1000 , mm^3/min$.
- **Formula**: $(Time\_{min} / 60) \\times MachineHourlyRate$.
